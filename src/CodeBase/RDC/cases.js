...
function whenCasesLoaded() {
	console.log("Cases Page Loaded successfully...");
}

MainApplication.CasesComponent.buildRating = function (rowId, key, data) {
...
MainApplication.CasesComponent.confirmSubmit = function (action) {
	MainApplication.confirmAction = MainApplication.CasesComponent.actionConfirmed;
	$("#confirmModal").modal("show");
};

MainApplication.CasesComponent.actionConfirmed = function () {
	MainApplication.CasesComponent.saveDataToList();
};

MainApplication.CasesComponent.saveDataToList = function () {
	...
	if ($spcontext.checkPassedValidation()) {
		...
		MainApplication.CasesComponent.proceedToList(formData, false);
	} else {
...
MainApplication.CasesComponent.proceedToList = function (formData) {
		...
		if (AppRequest.itemId == null) {
			vbContext.createItems([formData], globalDefinitions.stageDefinitions.listname, function (createdItemsProperties) {
				...
				vbContext.updateItems([updateObj], globalDefinitions.stageDefinitions.listname, function () {
					...
					MainApplication.CasesComponent.clearAllAttachments("SupportingDocuments", "fu");
					// $spcontext.redirect("#/", false);
					globalDefinitions.closeLoader();
...
MainApplication.CasesComponent.dateHandler = function () {
...
MainApplication.CasesComponent.deleteRowAttachment = function (elementBindProperty, index, elementId) {
    ...
    // Re-render UI
    MainApplication.CasesComponent.renderAttachments(
        elementBindProperty,
        property,
        elementId
    );
...
MainApplication.CasesComponent.clearAllAttachments = function (elementBindProperty, elementId) {
...
MainApplication.CasesComponent.renderAttachments = function (elementBindProperty, property, elementId) {
...
MainApplication.CasesComponent.recoverListData = function () {
...
MainApplication.CasesComponent.getRandomItem = function (array) {
    const randomIndex = Math.floor(Math.random() * array.length);
    return array[randomIndex];
}

MainApplication.CasesComponent.renderRandomHeader = function () {
    ...
    const randomItem = MainApplication.CasesComponent.getRandomItem(data);
