    ...
    (() => {
        ...
        function Z(t, e, o) {
            return (
                r().each(e, function (e, n) {
                    !o && I(t) && null === t.firstChild && F(n) && t.appendChild(ut("br")), t.appendChild(n);
                }),
                t
            );
        }
            ...
            if (n.length > 2) {
                ...
                if (i && 0 != e.offset && X(e)) {
                    var r,
                        a = i.nextSibling;
                    1 == a.nodeType
                        ? ((n = V((r = a.childNodes[0]), g.eq(t))), (e = {node: r, offset: 0}))
        ...
        r().fn.extend({
            summernote: function () {
                ...
                (n.langInfo = r().extend(!0, {}, r().summernote.lang["en-US"], r().summernote.lang[n.lang])),
                ...
                (o = [
                                ...
                                pt.walkPoint(
                                    ...
                                    function (e) {
                                        ...
                                        pt.isEditable(e.node) ||
                                            (n ? (pt.isLeftEdgePoint(e) && s.push(e.node), pt.isRightEdgePoint(e) && C.contains(s, e.node) && (i = e.node)) : (i = o ? pt.ancestor(e.node, t) : e.node),
                                            i && t(i) && a.push(i));
                                    },
                                    !0
                                ),
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            return (
                                ...
                                pt.isText(this.sc) && !pt.isEdgePoint(this.getStartPoint()) && ((o.sc = this.sc.splitText(this.so)), (o.so = 0), e && ((o.ec = o.sc), (o.eo = this.eo - this.so))),
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            return (
                                n.rightNode
                                    ? (n.rightNode.parentNode.insertBefore(t, n.rightNode), pt.isEmpty(n.rightNode) && (e || pt.isPara(t)) && n.rightNode.parentNode.removeChild(n.rightNode))
        ...
        const Et = {
            ...
            createFromNode: function (t) {
                ...
                return (
                    ...
                    pt.isBR(n) ? ((i = pt.listPrev(n).length - 1), (n = n.parentNode)) : pt.isVoid(n) && ((i = pt.listPrev(n).length), (n = n.parentNode)),
                    this.create(e, o, n, i)
                );
            },
                    ...
                    },
                    {
                        ...
                        value: function () {
                            this.$editable.html() !== this.stack[this.stackOffset].contents && this.recordUndo(),
                                this.stackOffset > 0 && (this.stackOffset--, this.applySnapshot(this.stack[this.stackOffset]));
                        },
                    },
                    {
                        key: "redo",
                    ...
                    },
                    {
                        ...
                        value: function (t, e) {
                            ...
                            return (
                                ...
                                r && (pt.appendChildNodes(a, C.from(r.childNodes), !0), pt.remove(r)),
                                t
                            );
                        },
                    },
                            ...
                            return (
                                r().each(t, function (t, i) {
                                    ...
                                    if ("LI" === l.parentNode.nodeName)
                                        ...
                                        (i = e ? pt.listDescendant(d, pt.isLi) : C.from(d.childNodes).filter(pt.isLi)),
                            ...
                            if (n) {
                                ...
                                if (
                                    (1 === this.options.blockquoteBreakingLevel
                                        ...
                                        : 2 === this.options.blockquoteBreakingLevel && (i = pt.lastAncestor(n, pt.isBlockquote)),
                                    i)
                                ) {
                        ...
                        value: function (t, e) {
                            for (
                                var o = pt.ancestor(t.commonAncestor(), pt.isCell),
                                    ...
                                    a = r()("<tr" + i + "></tr>"),
                                    s = new Gt(o, Gt.where.Row, Gt.requestAction.Add, r()(n).closest("table")[0]).getActionList(),
                                    l = 0;
                                l < s.length;
                                l++
                            ) {
                                ...
                                switch (c.action) {
                                    ...
                                    case Gt.resultAction.SumSpanCount:
                                        if ("top" === e && (c.baseCell.parent ? c.baseCell.closest("tr").rowIndex : 0) <= n[0].rowIndex) {
                                            var d = r()("<div></div>")
                                                .append(r()("<td" + u + ">" + pt.blank + "</td>").removeAttr("rowspan"))
                                                .html();
                                            a.append(d);
                                            break;
                                        }
                        ...
                        value: function (t) {
                            for (
                                var e = pt.ancestor(t.commonAncestor(), pt.isCell),
                                    ...
                                    i = o[0].rowIndex,
                                    a = new Gt(e, Gt.where.Row, Gt.requestAction.Delete, r()(o).closest("table")[0]).getActionList(),
                                    s = 0;
                                s < a.length;
                                s++
                            )
                                if (a[s]) {
                                    ...
                                    switch (a[s].action) {
                                        ...
                                        case Gt.resultAction.AddCell:
                                            ...
                                            u &&
                                                (d > 2
                                                    ? (d--, f.insertBefore(h, f.cells[n]), f.cells[n].setAttribute("rowSpan", d), (f.cells[n].innerHTML = ""))
                                                    : 2 === d && (f.insertBefore(h, f.cells[n]), f.cells[n].removeAttribute("rowSpan"), (f.cells[n].innerHTML = "")));
                                            continue;
                                        case Gt.resultAction.SubtractSpanCount:
                                            u &&
                                                (d > 2
                                                    ? (d--, l.setAttribute("rowSpan", d), c.rowIndex !== i && l.cellIndex === n && (l.innerHTML = ""))
                                                    : 2 === d && (l.removeAttribute("rowSpan"), c.rowIndex !== i && l.cellIndex === n && (l.innerHTML = "")));
                                            continue;
                        ...
                        value: function (t) {
                            for (
                                var e = pt.ancestor(t.commonAncestor(), pt.isCell),
                                    o = r()(e).closest("tr"),
                                    n = o.children("td, th").index(r()(e)),
                                    i = new Gt(e, Gt.where.Column, Gt.requestAction.Delete, r()(o).closest("table")[0]).getActionList(),
                                    a = 0;
                                a < i.length;
                                a++
                            )
                                    ...
                                    switch (i[a].action) {
                                        ...
                                        case Gt.resultAction.SubtractSpanCount:
                                            ...
                                            if (s.colSpan && s.colSpan > 1) {
                                                ...
                                                l > 2
                                                    ? (l--, s.setAttribute("colSpan", l), s.cellIndex === n && (s.innerHTML = ""))
                                                    : 2 === l && (s.removeAttribute("colSpan"), s.cellIndex === n && (s.innerHTML = ""));
                                            }
                                            continue;
                                        case Gt.resultAction.RemoveCell:
                    ...
                    (t = function t(e) {
                        ...
                        (this.insertParagraph = this.wrapCommand(function () {
                            ...
                            (this.createLink = this.wrapCommand(function (t) {
                                ...
                                if (!(u > 0 && o.isLimited(u))) {
                                    ...
                                    if (d) {
                                        ...
                                        f.push(h);
                                    } else f = o.style.styleNodes(c, {nodeName: "A", expandClosestSibling: !0, onlyPartialContains: !0});
                                    r().each(f, function (t, o) {
                                        r()(o).attr("href", n),
                                            a
                                                ? (r()(o).attr("target", "_blank"), s && e.push("noreferrer"), l && e.push("noopener"), e.length && r()(o).attr("rel", e.join(" ")))
                            ...
                            (this.removeMedia = this.wrapCommand(function () {
                                ...
                                t.closest("figure").length ? t.closest("figure").remove() : (t = r()(o.restoreTarget()).detach()),
                    ...
                    (e = [
                            ...
                            value: function () {
                                ...
                                this.$editable
                                    .on("keydown", function (e) {
                                        if (
                                            (e.keyCode === Nt.code.ENTER && t.context.triggerEvent("enter", e),
                        ...
                        },
                        {
                            ...
                            value: function (t, e) {
                                return (
                                    (t = t || 0),
                                    (void 0 === e || !(Nt.isMove(e.keyCode) || Nt.isNavigation(e.keyCode) || e.ctrlKey || e.metaKey || C.contains([Nt.code.BACKSPACE, Nt.code.DELETE], e.keyCode))) &&
                            ...
                            value: function (t) {
                                t
                                    ...
                                    : ((this.lastRange = Et.create(this.editable)),
                                      0 === r()(this.lastRange.sc).closest(".note-editable").length && (this.lastRange = Et.createFromBodyElement(this.editable)));
                            },
                        },
                        {
                            key: "getLastRange",
                        ...
                        },
                        {
                            ...
                            value: function (t, e, o) {
                                (t = Et.create()).isCollapsed() &&
                                    ...
                                    ("P" === o ? e.remove() : ["TH", "TD"].indexOf(o) >= 0 && e.firstChild.remove());
                            },
                        },
                        {
                            key: "insertImage",
                            value: function (t, e) {
                                ...
                                r()
                                    ...
                                    .then(function (t) {
                                        n.beforeCommand(),
                                            "function" == typeof e ? e(t) : ("string" == typeof e && t.attr("data-filename", e), t.css("width", Math.min(n.$editable.width(), t.width()))),
                                            t.show(),
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                ...
                                r().each(t, function (t, o) {
                                    var n = o.name;
                                    e.options.maximumImageFileSize && e.options.maximumImageFileSize < o.size
                        ...
                        },
                        {
                            ...
                            value: function (t, e) {
                                if (
                                    (document.execCommand("FormatBlock", !1, m.isMSIE ? "<" + t + ">" : t),
                                    e && e.length && (e[0].tagName.toUpperCase() !== t.toUpperCase() && (e = e.find(t)), e && e.length))
                                ) {
                            ...
                            value: function (t, e) {
                                ...
                                if ("" !== o) {
                                    ...
                                    if ((this.$editor.find(".note-status-output").html(""), r()(n).css(t, e), o.isCollapsed())) {
                                        ...
                                        i &&
                                            !pt.nodeLength(i) &&
                                            ((i.innerHTML = pt.ZERO_WIDTH_NBSP_CHAR), Et.createFromNode(i.firstChild).select(), this.setLastRange(), this.$editable.data("bogus", i));
                                    } else o.select();
                                } else {
                                    var a = r().now();
                        ...
                        value: function (t) {
                            ...
                            if (!this.context.isDisabled()) {
                                ...
                                if (o && o.items && o.items.length) {
                                    var n = o.files,
                                        i = o.getData("Text");
                                    n.length > 0 && this.options.allowClipboardImagePasting && (this.context.invoke("editor.insertImagesOrCallback", n), t.preventDefault()),
                                        i.length > 0 && this.context.invoke("editor.isLimited", i.length) && t.preventDefault();
            ...
            return (
                (t = function t(e) {
                    !(function (t, e) {
                        ...
                        (this.$dropzone = r()(['<div class="note-dropzone">', '<div class="note-dropzone-message"></div>', "</div>"].join("")).prependTo(this.$editor));
                }),
                (e = [
                    {
                        key: "initialize",
                        ...
                        value: function () {
                            ...
                            (this.documentEventHandlers.onDragenter = function (n) {
                                ...
                                i ||
                                    e.length ||
                                    !r ||
                                    (t.$editor.addClass("dragover"), t.$dropzone.width(t.$editor.width()), t.$dropzone.height(t.$editor.height()), o.text(t.lang.image.dragImageHere)),
                                    (e = e.add(n.target));
                            }),
                                    ...
                                    .on("drop", function (e) {
                                        ...
                                        e.preventDefault(),
                                            o && o.files && o.files.length
                                                ? (t.$editable.trigger("focus"), t.context.invoke("editor.insertImagesOrCallback", o.files))
                    ...
                    (o = (function (t, e) {
                        if (t) {
                            ...
                            return (
                                ...
                                "Map" === o || "Set" === o ? Array.from(t) : "Arguments" === o || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(o) ? he(t, e) : void 0
                            );
                        }
                    })(t)) ||
                                      ...
                                      var o = t.$editable.offset().top - t.$document.scrollTop(),
                                          ...
                                          i = function (e) {
                                              ...
                                              (r = t.options.minheight > 0 ? Math.max(r, t.options.minheight) : r),
                                                  ...
                                                  (a = t.options.minheight > 0 ? Math.max(a, t.options.minheight) : a),
                                                  (a = t.options.maxHeight > 0 ? Math.min(a, t.options.maxHeight) : a),
                                                  t.$editable.height(r),
                                                  t.$codable.height(a);
                                          };
                                ...
                                this.$handle.on("mousedown", function (e) {
                                    if (pt.isControlSizing(e.target)) {
                                        ...
                                        var o = t.$handle.find(".note-control-selection").data("target"),
                                            ...
                                            r = function (e) {
                                                t.context.invoke("editor.resizeTo", {x: e.clientX - n.left, y: e.clientY - (n.top - i)}, o, !e.shiftKey), t.update(o[0], e);
                                            };
                    ...
                    },
                    {
                        ...
                        value: function (t, e) {
                            ...
                            if ((this.context.invoke("imagePopover.update", t, e), o)) {
                                ...
                                n.css({display: "block", left: s.left - a.left, top: s.top - a.top, width: s.width, height: s.height}).data("target", i);
                                var l = new Image();
                                l.src = i.attr("src");
                            ...
                            value: function () {
                                if (this.lastWordRange) {
                                    ...
                                    if (e && (e[1] || e[2])) {
                                        ...
                                        this.context.options.linkTargetBlank && r()(i).attr("target", "_blank"),
            ...
            return (
                (t = function t(e) {
                    ...
                    !(function (t, e) {
                        ...
                        (this.keys = [Nt.code.ENTER, Nt.code.SPACE, Nt.code.PERIOD, Nt.code.COMMA, Nt.code.SEMICOLON, Nt.code.SLASH]),
            ...
            return (
                ...
                (e = [
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            return (
                                Object.prototype.hasOwnProperty.call(this.fontInstalledMap, t) || (this.fontInstalledMap[t] = m.isFontInstalled(t) || C.contains(this.options.fontNamesIgnoreCheck, t)),
                                    ...
                                    children: [
                                        this.button({
                                            ...
                                            click: function (t) {
                                                ...
                                                o && n
                                                    ? i.context.invoke("editor.color", {backColor: e.attr("data-backColor"), foreColor: e.attr("data-foreColor")})
                                                    : o
                                                    ? i.context.invoke("editor.color", {backColor: e.attr("data-backColor")})
                                                    : n && i.context.invoke("editor.color", {foreColor: e.attr("data-foreColor")});
                                            },
                                            callback: function (t) {
                                                var e = t.find(".note-recent-color");
                                                o && (e.css("background-color", i.options.colorButton.backColor), t.attr("data-backColor", i.options.colorButton.backColor)),
                                                    n ? (e.css("color", i.options.colorButton.foreColor), t.attr("data-foreColor", i.options.colorButton.foreColor)) : e.css("color", "transparent");
                                            },
                                        }),
                                        this.button({
                                        ...
                                        this.ui.dropdown({
                                            ...
                                            callback: function (t) {
                                                ...
                                                t.find(".note-holder-custom").each(function (t, o) {
                                                    var n = r()(o);
                                                    n.append(i.ui.palette({colors: e, colorsName: e, eventName: n.data("event"), container: i.options.container, tooltip: i.options.tooltip}).render());
                                                }),
                                ...
                                this.context.memo("button.paragraph", function () {
                                    return t.ui
                                        .buttonGroup([
                                            ...
                                            t.ui.dropdown([t.ui.buttonGroup({className: "note-align", children: [i, a, s, l]}), t.ui.buttonGroup({className: "note-list", children: [c, u]})]),
                                        ])
                                        .render();
                                }),
                                            ...
                                            ],
                                            {
                                                callback: function (e) {
                                                    e.find(".note-dimension-picker-mousecatcher")
                                                        ...
                                                        .on("mousedown", t.context.createInvokeHandler("editor.insertTable"))
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            this.context.memo("button.resizeFull", function () {
                                return t
                                    .button({contents: '<span class="note-fontsize-10">100%</span>', tooltip: t.lang.image.resizeFull, click: t.context.createInvokeHandler("editor.resize", "1")})
                                    .render();
                            }),
                                this.context.memo("button.resizeHalf", function () {
                                    return t
                                        .button({contents: '<span class="note-fontsize-10">50%</span>', tooltip: t.lang.image.resizeHalf, click: t.context.createInvokeHandler("editor.resize", "0.5")})
                                        .render();
                                }),
                                ...
                                this.context.memo("button.resizeNone", function () {
                                    return t
                                        .button({contents: t.ui.icon(t.options.icons.rollback), tooltip: t.lang.image.resizeNone, click: t.context.createInvokeHandler("editor.resize", "0")})
                                        .render();
                                }),
                                this.context.memo("button.floatLeft", function () {
                                    return t
                                        .button({contents: t.ui.icon(t.options.icons.floatLeft), tooltip: t.lang.image.floatLeft, click: t.context.createInvokeHandler("editor.floatMe", "left")})
                                        .render();
                                }),
                                this.context.memo("button.floatRight", function () {
                                    return t
                                        .button({contents: t.ui.icon(t.options.icons.floatRight), tooltip: t.lang.image.floatRight, click: t.context.createInvokeHandler("editor.floatMe", "right")})
                                        .render();
                                }),
                                this.context.memo("button.floatNone", function () {
                                    return t
                                        .button({contents: t.ui.icon(t.options.icons.rollback), tooltip: t.lang.image.floatNone, click: t.context.createInvokeHandler("editor.floatMe", "none")})
                                        .render();
                                }),
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            !this.isFollowing && a > l && a < c - o
                                ? ((this.isFollowing = !0), this.$editable.css({marginTop: this.$toolbar.outerHeight()}), this.$toolbar.css({position: "fixed", top: i, width: e, zIndex: 1e3}))
                                : this.isFollowing &&
                                  (a < l || a > c) &&
                                  ((this.isFollowing = !1), this.$toolbar.css({position: "relative", top: 0, width: "100%", zIndex: "auto"}), this.$editable.css({marginTop: ""}));
                        },
                    },
                    {
                        key: "changeContainer",
                    ...
                    (e = [
                        {
                            ...
                            value: function () {
                                ...
                                this.$dialog = this.ui.dialog({className: "link-dialog", title: this.lang.link.insert, fade: this.options.dialogsFade, body: e, footer: o}).render().appendTo(t);
                            },
                        },
                        {
                            key: "destroy",
                                    ...
                                    .Deferred(function (o) {
                                        ...
                                        e.ui.onDialogShown(e.$dialog, function () {
                                            e.context.triggerEvent("dialog.shown"),
                                                !t.url && g.isValidUrl(t.text) && (t.url = e.checkLinkUrl(t.text)),
                                                n
                                            ...
                                            a.prop("checked", s),
                                                r.one("click", function (r) {
                                                    r.preventDefault(), o.resolve({range: t.range, url: i.val(), text: n.val(), isNewWindow: a.is(":checked")}), e.ui.hideDialog(e.$dialog);
                                                });
                                        }),
                        ...
                        value: function (t, e) {
                            if (pt.isImg(t)) {
                                var o = r()(t).offset(),
                                    ...
                                    i = {};
                                this.options.popatmouse ? ((i.left = e.pageX - 20), (i.top = e.pageY)) : (i = o),
                                    (i.top -= n.top),
                                    (i.left -= n.left),
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            if (o && 11 === o[1].length) {
                                ...
                                e = r()("<iframe>")
                                    .attr("frameborder", 0)
                                    .attr("src", "https://drive.google.com/file/d/" + n[1] + "/preview")
                                    .attr("width", "640")
                                    .attr("height", "480");
                                ...
                                e = r()("<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>")
                                    .attr("frameborder", 0)
                                ...
                                var P = 0;
                                "undefined" !== u[6] && (P = u[6]),
                                    (e = r()('<iframe allowfullscreen sandbox="allow-same-origin allow-scripts allow-popups">')
                                        .attr("frameborder", 0)
                                        .attr(
                                            "src",
                                            "//" + u[1] + "/videos/embed/" + u[2] + "?loop=" + T + "&autoplay=" + E + "&muted=" + P + (S > 0 ? "&start=" + S : "") + (x > 0 ? "&end=" + b : "")
                                        )
                                        .attr("width", "560")
                                        .attr("height", "315"));
                                ...
                                e = r()("<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>")
                                    ...
                                    .attr("height", "310")
                                    .attr("width", "500")
                                    .attr("src", "https://v.qq.com/txp/iframe/player.html?vid=" + N + "&amp;auto=0");
                            } else if (h || p || m) e = r()("<video controls>").attr("src", t).attr("width", "640").attr("height", "360");
                            else {
                                if (!v || !v[0].length) return !1;
                                e = r()("<iframe>")
                                    .attr("frameborder", 0)
                                    .attr("src", "https://www.facebook.com/plugins/video.php?href=" + encodeURIComponent(v[0]) + "&show_text=0&width=560")
                                    .attr("width", "560")
                                    .attr("height", "301")
                                    .attr("scrolling", "no")
                                    .attr("allowtransparency", "true");
                        ...
                        value: function () {
                            ...
                            return Object.keys(e)
                                .map(function (o) {
                                    ...
                                    return (
                                        i.append(r()("<label><kbd>" + o + "</kdb></label>").css({width: 180, "margin-right": 10})).append(r()("<span></span>").html(t.context.memo("help." + n) || n)),
                                        i.html()
                                    );
                                })
                                .join("");
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            if (!e.range || (e.range.isCollapsed() && !t)) this.hide();
                                ...
                                (o.top -= n.top),
                                    (o.left -= n.left),
                                    this.$popover.css({display: "block", left: Math.max(o.left, 0) + -5, top: o.top + 5}),
                    ...
                    },
                    {
                        ...
                        value: function (t, e) {
                            ...
                            return e.map(function (e, n) {
                                ...
                                return i.append(o.template ? o.template(e) : e + ""), i.data({index: t, item: e}), 0 === t && 0 === n && i.addClass("active"), i;
                            });
                        },
                    },
                    {
                        ...
                        value: function (t) {
                            this.$popover.is(":visible") &&
                                (t.keyCode === Nt.code.ENTER
                                    ...
                                    : t.keyCode === Nt.code.DOWN && (t.preventDefault(), this.moveDown()));
                        },
                    },
                    {
                        key: "searchKeyword",
        ...
        const Ko = function (t, e) {
            return function () {
                var o = "object" === zo(arguments[1]) ? arguments[1] : arguments[0],
            ...
            return (
                (t = function t(e, o) {
                    if (
                        ...
                        (this.$node = e),
                        (this.options = r().extend({}, {title: "", target: o.container, trigger: "hover focus", placement: "bottom"}, o)),
                        (this.$tooltip = r()(['<div class="note-tooltip">', '<div class="note-tooltip-arrow"></div>', '<div class="note-tooltip-content"></div>', "</div>"].join(""))),
                        ...
                        this.options.trigger.split(" ").forEach(function (t) {
                            "hover" === t
                                ? (e.off("mouseenter mouseleave"), e.on("mouseenter", n).on("mouseleave", i))
                                : "click" === t
                                ? e.on("click", a)
                                : "focus" === t && e.on("focus", n).on("blur", i);
                        });
                    }
                }),
                (e = [
                    {
                        ...
                        value: function () {
                            ...
                            var n = this.$tooltip,
                                i = this.options.title || t.attr("title") || t.data("title"),
                                a = this.options.placement || t.data("placement");
                            n.addClass(a), n.find(".note-tooltip-content").text(i), n.appendTo(this.options.target);
                            var s = t.outerWidth(),
                                l = t.outerHeight(),
                                c = n.outerWidth(),
                                u = n.outerHeight();
                            "bottom" === a
                                ? n.css({top: e.top + l, left: e.left + (s / 2 - c / 2)})
                                : "top" === a
                                ? n.css({top: e.top - u, left: e.left + (s / 2 - c / 2)})
                                : "left" === a
                                ? n.css({top: e.top + (l / 2 - u / 2), left: e.left - c})
                                : "right" === a && n.css({top: e.top + (l / 2 - u / 2), left: e.left + s}),
                                n.addClass("in");
                        },
                    },
                    {
        ...
        function Yo(t, e) {
            for (var o = 0; o < e.length; o++) {
                var n = e[o];
                (n.enumerable = n.enumerable || !1), (n.configurable = !0), "value" in n && (n.writable = !0), Object.defineProperty(t, Xo(n.key), n);
            }
        }
        function Xo(t) {
            var e = (function (t, e) {
            ...
            return (
                (t = function t(e, o) {
                    !(function (t, e) {
                        ...
                        (this.$button = e),
                        (this.options = r().extend({}, {target: o.container}, o)),
                        this.setEvent();
                }),
                (e = [
                    {
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            var t = this.$button.next(),
                                ...
                                o = t.outerWidth(),
                                n = r()(window).width(),
                                i = parseFloat(r()(this.options.target).css("margin-right"));
                            e.left + o > n - i ? t.css("margin-left", n - i - (e.left + o)) : t.css("margin-left", "");
                        },
                    },
                    {
                        key: "hide",
        ...
        r()(document).on("click.note-dropdown-menu", function (t) {
            r()(t.target).closest(".note-btn-group").length || (r()(".note-btn-group.open .note-btn.active").removeClass("active"), r()(".note-btn-group.open").removeClass("open"));
        }),
            r()(document).on("click.note-dropdown-menu", function (t) {
                r()(t.target).closest(".note-dropdown-menu").parent().removeClass("open"), r()(t.target).closest(".note-dropdown-menu").parent().find(".note-btn.active").removeClass("active");
            });
        const Jo = Qo;
        function tn(t) {
            return (
        ...
        function en(t, e) {
            for (var o = 0; o < e.length; o++) {
                var n = e[o];
                (n.enumerable = n.enumerable || !1), (n.configurable = !0), "value" in n && (n.writable = !0), Object.defineProperty(t, on(n.key), n);
            }
        }
        function on(t) {
            var e = (function (t, e) {
            ...
            return (
                (t = function t(e) {
                    !(function (t, e) {
                        ...
                        (this.$modal = e),
                        (this.$backdrop = r()('<div class="note-modal-backdrop"></div>'));
                }),
                (e = [
                    {
                        key: "show",
        ...
        var rn = Ko('<div class="note-editor note-frame"></div>'),
            ...
            ln = Ko('<textarea class="note-codable" aria-multiline="true"></textarea>'),
            cn = Ko('<div class="note-editable" contentEditable="true" role="textbox" aria-multiline="true"></div>'),
            un = Ko(
                [
            ...
            fn = Ko(
                ['<div class="note-editable" contentEditable="true" role="textbox" aria-multiline="true"></div>', '<output class="note-status-output" role="status" aria-live="polite"></output>'].join(
                    ""
                )
            ),
            hn = Ko('<div class="note-btn-group"></div>'),
            pn = Ko('<button type="button" class="note-btn" tabindex="-1"></button>', function (t, e) {
                e &&
                    e.tooltip &&
                    (t.attr({"aria-label": e.tooltip}),
                    t.data("_lite_tooltip", new Go(t, {title: e.tooltip, container: e.container})).on("click", function (t) {
                        r()(t.currentTarget).data("_lite_tooltip").hide();
                    })),
                    e.contents && t.html(e.contents),
                    e && e.data && "dropdown" === e.data.toggle && t.data("_lite_dropdown", new Jo(t, {container: e.container})),
                    e && e.codeviewKeepButton && t.addClass("note-codeview-keep");
            }),
            mn = Ko('<div class="note-dropdown-menu" role="list"></div>', function (t, e) {
                var o = Array.isArray(e.items)
                    ? e.items.map(function (t) {
                          var o = "string" == typeof t ? t : t.value || "",
                              n = e.template ? e.template(t) : t,
                              i = r()('<a class="note-dropdown-item" href="#" data-value="' + o + '" role="listitem" aria-label="' + o + '"></a>');
                ...
                t.html(o).attr({"aria-label": e.title}),
                    t.on("click", "> .note-dropdown-item", function (t) {
                        var o = r()(this),
                            n = o.data("item"),
                            i = o.data("value");
                        n.click ? n.click(o) : e.itemClick && e.itemClick(t, n, i);
                    }),
                    e && e.codeviewKeepButton && t.addClass("note-codeview-keep");
            }),
            vn = Ko('<div class="note-dropdown-menu note-check" role="list"></div>', function (t, e) {
                var o = Array.isArray(e.items)
                    ? e.items.map(function (t) {
                          var o = "string" == typeof t ? t : t.value || "",
                              n = e.template ? e.template(t) : t,
                              i = r()('<a class="note-dropdown-item" href="#" data-value="' + o + '" role="listitem" aria-label="' + t + '"></a>');
                          return i.html([In(e.checkClassName), " ", n]).data("item", t), i;
                      })
                    : e.items;
                t.html(o).attr({"aria-label": e.title}),
                    t.on("click", "> .note-dropdown-item", function (t) {
            ...
            bn = function (t, e) {
                return hn(
                    [
                        pn({className: "dropdown-toggle", contents: t.title + " " + In("note-icon-caret"), tooltip: t.tooltip, data: {toggle: "dropdown"}}),
                        mn({className: t.className, items: t.items, template: t.template, itemClick: t.itemClick}),
                    ],
                    {callback: e}
                ).render();
            },
            yn = function (t, e) {
                return hn(
                    [
                        pn({className: "dropdown-toggle", contents: t.title + " " + In("note-icon-caret"), tooltip: t.tooltip, data: {toggle: "dropdown"}}),
                        vn({className: t.className, checkClassName: t.checkClassName, items: t.items, template: t.template, itemClick: t.itemClick}),
                    ],
                    {callback: e}
                ).render();
            },
            kn = function (t) {
                return hn([
                    pn({className: "dropdown-toggle", contents: t.title + " " + In("note-icon-caret"), tooltip: t.tooltip, data: {toggle: "dropdown"}}),
                    mn([hn({className: "note-align", children: t.items[0]}), hn({className: "note-list", children: t.items[1]})]),
                ]).render();
            },
            wn = function (t) {
                return hn(
                                ...
                                .on("mousemove", function (e) {
                                    !(function (t, e, o) {
                                        var n,
                                            ...
                                            l = i.find(".note-dimension-picker-highlighted"),
                                            c = i.find(".note-dimension-picker-unhighlighted");
                                        if (void 0 === t.offsetX) {
                                            var u = r()(t.target).offset();
                                            n = {x: t.pageX - u.left, y: t.pageY - u.top};
            ...
            Cn = Ko('<div class="note-color-palette"></div>', function (t, e) {
                for (var o = [], n = 0, i = e.colors.length; n < i; n++) {
                    for (var a = e.eventName, s = e.colors[n], l = e.colorsName[n], c = [], u = 0, d = s.length; u < d; u++) {
                        var f = s[u],
                            h = l[u];
                        c.push(
                            [
                ...
                t.html(o.join("")),
                    t.find(".note-color-btn").each(function () {
                        r()(this).data("_lite_tooltip", new Go(r()(this), {container: e.container}));
                    });
            }),
            Sn = function (t, e) {
                return hn({
                    ...
                    children: [
                        ...
                        pn({className: "dropdown-toggle", contents: In("note-icon-caret"), tooltip: t.lang.color.more, data: {toggle: "dropdown"}}),
                        mn({
                            items: [
                                "<div>",
                            ...
                            callback: function (o) {
                                o.find(".note-holder").each(function () {
                                    var e = r()(this);
                                    e.append(Cn({colors: t.colors, eventName: e.data("event")}).render());
                                }),
                                    "fore" === e
                                        ? (o.find(".btn-background-color").hide(), o.css({"min-width": "210px"}))
                                        : "back" === e && (o.find(".btn-foreground-color").hide(), o.css({"min-width": "210px"}));
                            },
                            click: function (o) {
                                var n = r()(o.target),
                                    i = n.data("event"),
                                ...
                                if (("cp" === a ? o.stopPropagation() : "cpbackColor" === a ? (a = l) : "cpforeColor" === a && (a = s), i && a)) {
                                    var c = "backColor" === i ? "background-color" : "color",
                                        u = n.closest(".note-color").find(".note-recent-color"),
                                        d = n.closest(".note-color").find(".note-current-color-button");
                                    u.css(c, a), d.attr("data-" + i, a), "fore" === e ? t.itemClick("foreColor", a) : "back" === e ? t.itemClick("backColor", a) : t.itemClick(i, a);
                                }
                            },
                        }),
                    ],
            ...
            xn = Ko('<div class="note-modal" aria-hidden="false" tabindex="-1" role="dialog"></div>', function (t, e) {
            ...
            Tn = function (t) {
                ...
                return xn({title: t.lang.video.insert, fade: t.fade, body: e, footer: o}).render();
            },
            En = function (t) {
                var e =
                ...
                return xn({title: t.lang.image.insert, fade: t.fade, body: e, footer: o}).render();
            },
            Pn = function (t) {
                var e =
                ...
                return xn({className: "link-dialog", title: t.lang.link.insert, fade: t.fade, body: e, footer: o}).render();
            },
            Nn = Ko(['<div class="note-popover bottom">', '<div class="note-popover-arrow"></div>', '<div class="popover-content note-children-container"></div>', "</div>"].join(""), function (t, e) {
                ...
                ui_template: function (t) {
                    return {
                        ...
                        createLayout: function (e) {
                            var o = (t.airMode ? dn([sn([ln(), fn()])]) : "bottom" === t.toolbarPosition ? rn([sn([ln(), cn()]), an(), un()]) : rn([an(), sn([ln(), cn()]), un()])).render();
                            return (
                                o.insertAfter(e),
                                {
                                    note: e,
