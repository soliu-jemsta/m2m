...
(function (t) {
    ...
    t.extend(i.prototype, {
            ...
            if (((i = i.target || i), "input" !== i.nodeName.toLowerCase() && (i = t("input", i.parentNode)[0]), !t.datepicker._isDisabledDatepicker(i) && t.datepicker._lastInput !== i)) {
                ...
                (s = t.datepicker._getInst(i)),
                    ...
                    a !== !1 &&
                        ...
                        t.datepicker._pos || ((t.datepicker._pos = t.datepicker._findPos(i)), (t.datepicker._pos[1] += i.offsetHeight)),
                        (r = !1),
                        t(i)
                            .parents()
                            .each(function () {
        ...
        _generateHTML: function (t) {
            ...
            if ((0 > Z && ((Z += 12), te--), Q))
                for (
                    e = this._daylightSavingAdjust(new Date(Q.getFullYear(), Q.getMonth() - U[0] * U[1] + 1, Q.getDate())), e = J && J > e ? J : e;
                ...
                for (x = "", this.maxRows = 4, C = 0; U[1] > C; C++) {
                    ...
                    for (
                        I +=
                            ...
                            this._generateMonthYearHeader(t, Z, te, J, Q, k > 0 || C > 0, f, m) +
                        ...
                        for (I += "<tr>", E = u ? "<td class='ui-datepicker-week-col'>" + this._get(t, "calculateWeek")(z) + "</td>" : "", w = 0; 7 > w; w++)
                            (W = g ? g.apply(t.input ? t.input[0] : null, [z]) : [!0, ""]),
                                ...
                                (E +=
                                    ...
                                    ((z.getTime() === D.getTime() && Z === t.selectedMonth && t._keyEvent) || (b.getTime() === z.getTime() && b.getTime() === D.getTime())
                                        ? " " + this._dayOverClass
                                        : "") +
